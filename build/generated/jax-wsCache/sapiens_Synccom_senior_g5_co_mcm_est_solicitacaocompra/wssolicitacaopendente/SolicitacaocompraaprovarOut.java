...
/**
 * <p>Classe Java de solicitacaocompraaprovarOut complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="solicitacaocompraaprovarOut"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="retorno" type="{http://services.senior.com.br}solicitacaocompraaprovarOutRetorno" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "solicitacaocompraaprovarOut", propOrder = {
    "codigoResultado",
    "erroExecucao",
    "resultado",
    "retorno"
})
public class SolicitacaocompraaprovarOut {
    ...
    protected List<SolicitacaocompraaprovarOutRetorno> retorno;
     ...
     * {@link SolicitacaocompraaprovarOutRetorno }
     * 
     * 
     */
    public List<SolicitacaocompraaprovarOutRetorno> getRetorno() {
        if (retorno == null) {
            retorno = new ArrayList<SolicitacaocompraaprovarOutRetorno>();
        }
        return this.retorno;
    }
