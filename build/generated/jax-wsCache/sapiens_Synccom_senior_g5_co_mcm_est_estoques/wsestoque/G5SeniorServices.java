 ...
 * 
 */
@WebServiceClient(name = "g5-senior-services", targetNamespace = "http://services.senior.com.br", wsdlLocation = "http://sapiensmid/g5-senior-services/sapiens_Synccom_senior_g5_co_mcm_est_estoques?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://sapiensmid/g5-senior-services/sapiens_Synccom_senior_g5_co_mcm_est_estoques?wsdl");
     ...
     * 
     * @return
     *     returns SapiensSynccomSeniorG5CoMcmEstEstoques
     */
    @WebEndpoint(name = "sapiens_Synccom_senior_g5_co_mcm_est_estoquesPort")
    public SapiensSynccomSeniorG5CoMcmEstEstoques getSapiensSynccomSeniorG5CoMcmEstEstoquesPort() {
        return super.getPort(new QName("http://services.senior.com.br", "sapiens_Synccom_senior_g5_co_mcm_est_estoquesPort"), SapiensSynccomSeniorG5CoMcmEstEstoques.class);
    }
     ...
     */
    @WebEndpoint(name = "sapiens_Synccom_senior_g5_co_mcm_est_estoquesPort")
    public SapiensSynccomSeniorG5CoMcmEstEstoques getSapiensSynccomSeniorG5CoMcmEstEstoquesPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.senior.com.br", "sapiens_Synccom_senior_g5_co_mcm_est_estoquesPort"), SapiensSynccomSeniorG5CoMcmEstEstoques.class, features);
    }
