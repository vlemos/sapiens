 ...
 * 
 */
@WebServiceClient(name = "g5-senior-services", targetNamespace = "http://services.senior.com.br", wsdlLocation = "http://sapiensmid/g5-senior-services/sapiens_SyncMCWFUsers?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://sapiensmid/g5-senior-services/sapiens_SyncMCWFUsers?wsdl");
     ...
     * 
     * @return
     *     returns SapiensSyncMCWFUsers
     */
    @WebEndpoint(name = "sapiens_SyncMCWFUsersPort")
    public SapiensSyncMCWFUsers getSapiensSyncMCWFUsersPort() {
        return super.getPort(new QName("http://services.senior.com.br", "sapiens_SyncMCWFUsersPort"), SapiensSyncMCWFUsers.class);
    }
     ...
     */
    @WebEndpoint(name = "sapiens_SyncMCWFUsersPort")
    public SapiensSyncMCWFUsers getSapiensSyncMCWFUsersPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.senior.com.br", "sapiens_SyncMCWFUsersPort"), SapiensSyncMCWFUsers.class, features);
    }
