 ...
 * 
 */
@WebServiceClient(name = "g5-senior-services", targetNamespace = "http://services.senior.com.br", wsdlLocation = "http://sapiensmid/g5-senior-services/sapiens_Synccom_senior_g5_co_mcm_est_ordemcompra?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://sapiensmid/g5-senior-services/sapiens_Synccom_senior_g5_co_mcm_est_ordemcompra?wsdl");
     ...
     * 
     * @return
     *     returns SapiensSynccomSeniorG5CoMcmEstOrdemcompra
     */
    @WebEndpoint(name = "sapiens_Synccom_senior_g5_co_mcm_est_ordemcompraPort")
    public SapiensSynccomSeniorG5CoMcmEstOrdemcompra getSapiensSynccomSeniorG5CoMcmEstOrdemcompraPort() {
        return super.getPort(new QName("http://services.senior.com.br", "sapiens_Synccom_senior_g5_co_mcm_est_ordemcompraPort"), SapiensSynccomSeniorG5CoMcmEstOrdemcompra.class);
    }
     ...
     */
    @WebEndpoint(name = "sapiens_Synccom_senior_g5_co_mcm_est_ordemcompraPort")
    public SapiensSynccomSeniorG5CoMcmEstOrdemcompra getSapiensSynccomSeniorG5CoMcmEstOrdemcompraPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.senior.com.br", "sapiens_Synccom_senior_g5_co_mcm_est_ordemcompraPort"), SapiensSynccomSeniorG5CoMcmEstOrdemcompra.class, features);
    }
