...
/**
 * <p>Classe Java de ordemcomprareprovarOut complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="ordemcomprareprovarOut"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="retorno" type="{http://services.senior.com.br}ordemcomprareprovarOutRetorno" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "ordemcomprareprovarOut", propOrder = {
    "codigoResultado",
    "erroExecucao",
    "resultado",
    "retorno"
})
public class OrdemcomprareprovarOut {
    ...
    protected List<OrdemcomprareprovarOutRetorno> retorno;
     ...
     * {@link OrdemcomprareprovarOutRetorno }
     * 
     * 
     */
    public List<OrdemcomprareprovarOutRetorno> getRetorno() {
        if (retorno == null) {
            retorno = new ArrayList<OrdemcomprareprovarOutRetorno>();
        }
        return this.retorno;
    }
